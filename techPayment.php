<?php include("header.php"); ?>
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Teacher Payment Form</h3> 
						...
						<div class="col-md-5">
							<div class="form-group">
     						 ...
     						 <div class="form-group">
						        ...
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <input name="tid" placeholder="Teacher ID" class="form-control" type="text" required="required">
						           	</select>
						           </div>
						        </div>
     						 </div>
					...
					<!-- inserting into database -->
						...
						if (isset($_POST["submit"])) {
							...
							$sql1 = "SELECT * FROM techpayment WHERE tid='".$_POST["tid"]."' ";
								$result = $conn->query($sql1);
								if ($result->num_rows > 0) {
									echo "<script>alert('Sorry, Payment already recorded!');</script>";
								}else{
									$sql = "INSERT INTO techpayment (name, tid, salary, paid, due, dates, total) VALUES('".$_POST["name"]."', '".$_POST["tid"]."','".$_POST["salary"]."','".$_POST["paid"]."','".$_POST["due"]."','".$_POST["dates"]."','".$_POST["total"]."')";
