...
<?php 
 ...
 ?>
					...
					<?php
							$sql="SELECT * FROM stuff WHERE ns_id = $ns_id ";
...
<!--Updating into database -->
						...
						if (isset($_POST["submit"])) {
								...
								$sql = "UPDATE stuff SET name = '" .$_POST["name"]. "', email='" .$_POST["email"]."', contact='" .$_POST["contact"]."', dob='" .$_POST["dob"]."' , address='" .$_POST["address"]."' , degree='" .$_POST["degree"]."' , gender='" .$_POST["gender"]."' , salary='" .$_POST["salary"]."' WHERE ns_id = $ns_id";
								if ($conn->query($sql)===TRUE) {
									echo "<script>alert('Successfully Updated Non Stuff!');</script>";
								} else {
									echo "<script>alert('Error Updating Non Stuff!');</script>";
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Update Non Stuff</h3> 
					<form class="well form-horizontal" action="" method="post" id="contact_form">
						...
						<div class="col-md-4">
     						 ...
     						 <div class="form-group">
						        ...
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           	<input name="submit" placeholder="Address" class="form-control" type="submit" value="Update NStuff" style="background-color:#3739d580;;color:#fff;">
						           </div>
						        </div>
     						 </div>
     						 <div class="form-group">
