			...
			<div class="col-md-9 hstu">
					...
					<!-- Selecting from database -->
						...
						if (isset($_POST["search"])) {
								$key = $_POST["search"];
								$sql = "SELECT * FROM nspay WHERE name like '%$key%' OR nid like '%$key%' OR dates like '%$key%' ";
								...
								?>
													...
													<td><a href="updnsPay.php?id=<?php echo $row['id']?>">Update</a></td>
													<td><a href="delnsPay.php?id=<?php echo $row['id']?>">Delete</a></td>
								<?php
												echo "</tr>";
										}
									echo "</table>";
