<?php include("header.php"); ?>
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Payment of NonStuff</h3> 
						<form action="" method="post" enctype="multipart/form-data">

					<!-- Selecting from database -->
						<?php include("config.php"); ?>
						<?php 
								$sql = "SELECT * FROM nspay";
					...
					<form action="searchnsPay.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
						        
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <a href="nsPay.php"><input name="addnew" class="form-control" type="button" value="Add New" style="width:110px;"></a>
						           </div>
						        </div>
     					</div>
     					<div class="form-group">
