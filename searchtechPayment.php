			...
			<div class="col-md-9 hstu">
					...
					<!-- Selecting from database -->
						...
						if (isset($_POST["search"])) {
								$key = $_POST["search"];
								$sql = "SELECT * FROM techpayment WHERE name like '%$key%' OR tid like '%$key%' OR dates like '%$key%' ";
								...
								?>
													...
													<td><a href="updtechPayment.php?id=<?php echo $row['id']?>">Update</a></td>
													<td><a href="deltechPayment.php?id=<?php echo $row['id']?>">Delete</a></td>
								<?php
												echo "</tr>";
										}
									echo "</table>";
					...
					<form action="searchtechPayment.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
						        
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <a href="techPayment.php"><input name="addnew" class="form-control" type="button" value="Add New" style="width:110px;"></a>
						           </div>
						        </div>
     					</div>
     					<div class="form-group">
