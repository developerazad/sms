<?php include("header.php"); ?>
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Registered Non Stuffs</h3> 
					...
					<!-- Selecting from database -->
						...
						<?php 
								...
								?>
													...
													<td><a href="updatenStuff.php?ns_id=<?php echo $row['ns_id']?>">Update</a></td>
													<td><a href="deletenStuff.php?ns_id=<?php echo $row['ns_id']?>">Delete</a></td>
					...
					<form action="searchnStuff.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
						        
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <a href="entrynStuff.php"><input name="addnew" class="form-control" type="button" value="Add New" style="width:110px;"></a>
						           </div>
						        </div>
     					</div>
     					<div class="form-group">
