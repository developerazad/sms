...
<?php 
 ...
 ?>
					...
					<?php
							$sql="SELECT * FROM techpayment WHERE id = $id ";
...
<!--Updating into database -->
						...
						if (isset($_POST["submit"])) {
								...
								$sql = "UPDATE techpayment SET name = '" .$_POST["name"]. "', tid='" .$_POST["tid"]."', salary='" .$_POST["salary"]."', paid='" .$_POST["paid"]."' , due='" .$_POST["due"]."' , dates='" .$_POST["dates"]."' , total='" .$_POST["total"]."'  WHERE id = $id";
		...
		<div class="col-md-12">
			...
			<div class="col-md-9 hstu">
					<h3 class="text-center">Update Teacher Payment</h3> 
						...
						<div class="col-md-5">
							<div class="form-group">
     						 ...
     						 <div class="form-group">
						        ...
						        <div class="col-md-4 inputGroupContainer">
						          <div class="input-group">
						           <input name="tid" placeholder="Teacher ID" class="form-control" type="text" required="required" value="<?php echo $tid; ?>">
						           	</select>
						           </div>
						        </div>
     						 </div>
